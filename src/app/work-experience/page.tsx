...
export default function WorkExperience() {
    const { workExperiences, isLoading: isLoadingWorkExperiences, fetchWorkExperiences } = useWorkExperienceManager();
                    ...
                    {isLoadingWorkExperiences ? (
                        ...
                        <div className="space-y-6">
                            {validWorkExperiences.map((experience) => (
                                <div
                                    key={experience.id}
                                    className="bg-white border border-gray-200 rounded-xl shadow-sm hover:shadow-lg transition-all duration-300 p-6 hover:border-gray-300"
                                >
                                    {/* Header Section */}
                                    <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between mb-4">
                                        ...
                                        <div className="mt-2 lg:mt-0">
                                            <span className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-medium border ${getEmploymentTypeColor(experience.employmenttype)}`}>
