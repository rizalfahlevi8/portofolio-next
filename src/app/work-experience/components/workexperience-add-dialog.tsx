...
import { WorkExperienceFormValues, workExperienceSchema } from "@/domain/workexperience-schema";
...
export default function AddWorkExperienceDialog({ onWorkExperienceAdded }: AddWorkExperienceDialogProps) {
    ...
    const { addWorkExperience } = useWorkExperienceManager();
