...
import { useWorkExperienceManager } from "@/hooks/useWorkExperience";
import {
    Code,
    Loader2,
    MapPin,
...
import { WorkExperienceFormValues } from "@/domain/workexperience-schema";

export default function WorkExperience() {
    const { workExperiences, isLoading: isLoadingWorkExperiences, updateWorkExperience, deleteWorkExperience, fetchWorkExperiences } = useWorkExperienceManager();
    ...
    const validWorkExperiences = workExperiences?.filter((experience) => experience && experience.id) || [];
    ...
    const handleWorkExperienceAdded = () => {
     ...
     const handleUpdateWorkExperience = async (workExperienceId: string, data: WorkExperienceFormValues) => {
    ...
    const handleDeleteWorkExperience = async (workExperienceId: string) => {
     ...
     const isTemporaryWorkExperience = (workExperienceId: string | undefined | null): boolean => {
                ...
                <div className="flex-1 space-y-6 p-8">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-4">
                            <AddWorkExperienceDialog onWorkExperienceAdded={handleWorkExperienceAdded} />
                        </div>
                    </div>
                    <Separator />
                     ...
                     {isLoadingWorkExperiences ? (
                        ...
                        <div className="text-center py-12 text-muted-foreground">
                            ...
                            <p className="text-lg font-medium mb-2">Belum ada pengalaman kerja yang ditambahkan</p>
                            <p className="text-sm">
                                Mulai tambahkan pengalaman kerja pertama kamu menggunakan tombol tambah di atas!
                            </p>
                        </div>
                    )}
                </div>
