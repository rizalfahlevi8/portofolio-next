                      ...
                      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 mb-4">
                        ...
                        <div className="space-y-3 min-w-0">
                          ...
                          {projectItem.technology &&
                            projectItem.technology.length > 0 && (
                              <div className="space-y-1">
                                <div className="flex items-center gap-2">
                                  ...
                                  {projectItem.photo
                                    ...
                                    .map((photo, index) => {
                                      ...
                                      return (
                                        <div
                                          key={index}
                                          className="relative w-12 h-8 rounded overflow-hidden border flex-shrink-0"
                                        >
                                          <Image
                                            src={photoUrl}
                                            alt={`${
                                              projectItem.title
                                            } tampilan aplikasi ${index + 1}`}
                                            fill
                        ...
                        <div className="flex items-center gap-2 text-xs text-muted-foreground min-w-0 flex-shrink">
                          ...
                          {projectItem.updatedAt && (
                            <span className="hidden sm:inline">
                              • Updated {formatDate(projectItem.updatedAt)}
                            </span>
                          )}
                        </div>
