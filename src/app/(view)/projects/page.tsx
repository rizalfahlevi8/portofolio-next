                ...
                <div className="lg:pb-16">
                  ...
                  <ul className="flex flex-col gap-4 mt-4 md:mt-5">
                    {project.technology.slice(0, 2).map((technology, index) => (
                      <li
                        key={index}
                        className="flex gap-2 text-sm md:text-base text-black/50"
                      >
                    ...
                    {project.technology.length > 2 && (
                      <li className="flex gap-2 text-sm md:text-base text-black/30">
                        ...
                        <span className="italic">
                          and {project.technology.length - 2} more...
                        </span>
                      </li>
                    )}
                  </ul>
                  ...
                  <Link
                    href="#"
                    className="bg-gray-950 text-white h-12 w-full md:w-auto px-6 rounded-xl font-semibold inline-flex items-center justify-center gap-2 mt-8 cursor-pointer"
                  >
                    <span>Details</span>
