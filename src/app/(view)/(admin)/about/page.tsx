...
import { BriefcaseBusiness, Code, ExternalLink, FilePen, Github, Loader2, Tag, UserPen } from "lucide-react";
...
export default function About() {
    const { about, isLoading: isLoadingAbout, updateAbout, fetchAbout } = useAboutManager();
                ...
                <div className="flex-1 space-y-8 p-8">
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center gap-4">
                            {user && <EditAboutDialog about={user} onUpdate={handleUpdateAbout} isUpdating={updatingId === user.id} />}
                        </div>
                    </div>
                    ...
                    {isLoadingAbout ? (
                                    ...
                                    <div className="flex flex-col lg:flex-row gap-8">
                                        ...
                                        <div className="flex-1 min-w-0 space-y-6">
                                            ...
                                            <div className="space-y-3 text-center lg:text-left">
                                                ...
                                                <p className="text-sm text-muted-foreground leading-relaxed max-w-2xl" style={{ whiteSpace: "pre-line" }}>
                                                    {user.introduction}
                                                </p>
                                            </div>
                                                    ...
                                                    <div className="flex flex-wrap gap-3 justify-center lg:justify-start">
                                                        {user.sosmed.map((sosmed) => {
                                                            ...
                                                            return (
                                                                ...
                                                                >
                                                                    {sosmed.name ? (
                                                                        <i className={`fa-brands fa-${sosmed.name} text-lg group-hover:scale-110 transition-transform`} />
                                                                    ) : (
                                            ...
                                            <Card key={exp.id} className="shadow-sm hover:shadow-md transition-shadow">
                                                ...
                                                <CardContent className="pt-0">
                                                    <div className="text-xs font-medium text-muted-foreground bg-muted/50 px-3 py-2 rounded-lg inline-block">
                                                        {formatDate(new Date(exp.startDate))} - {formatDate(exp.endDate ? new Date(exp.endDate) : null)}
                                                    </div>
                                                </CardContent>
                                            </Card>
                                        ))}
                        ...
                        <div className="flex flex-col items-center justify-center py-16 text-center">
                            ...
                            <h3 className="text-xl font-semibold text-foreground mb-2">Data Tidak Ditemukan</h3>
                            <p className="text-muted-foreground max-w-md">
                                Data diri kamu gagal dimuat. Silakan coba refresh halaman atau hubungi administrator.
                            </p>
                        </div>
                    )}
                </div>
