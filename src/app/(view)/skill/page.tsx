...
import { SkillFormValues, skillSchema } from "@/domain/skill-schema";
...
import { SkillEditDropdown } from "@/app/(view)/skill/components/skill-edit-dropdown";
            ...
            <SidebarInset>
                <div className="flex-1 space-y-6 p-8">
                    <div className="flex items-center justify-between">
                        <Heading title="Skills Management" description="Kelola data kemampuan dan teknologi yang kamu kuasai" />
                                        ...
                                        <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
                                            <div>
                                                ...
                                                <ul className="space-y-1 text-xs">
                                                    <li>• Format: <code className="bg-background px-1 rounded">devicon-[tech]-[variant]</code></li>
                                                    <li>• Contoh: <code className="bg-background px-1 rounded">devicon-javascript-original</code></li>
                                            ...
                                            <div>
                                                ...
                                                <ul className="space-y-1 text-xs">
                                                    <li>• <a href="https://devicon.dev/" target="_blank" className="text-blue-600 underline">Devicon Gallery</a> - Lihat semua icon</li>
                                                    <li>• <a href="https://github.com/devicons/devicon" target="_blank" className="text-blue-600 underline">GitHub Repo</a> - Dokumentasi lengkap</li>
                                                </ul>
                                            </div>
                                        </div>
                                    </div>
                        ...
                        <CardContent>
                            {isLoadingSkills ? (
                                                ...
                                                return (
                                                    ...
                                                    >
                                                        <div className="flex items-center gap-3 mb-3">
                                                            ...
                                                            <span className="font-medium text-sm flex-1">{skill.name || 'Unnamed Skill'}</span>
                                                            {isTemp && (
                                ...
                                <div className="text-center py-12 text-muted-foreground">
                                    ...
                                    <p className="text-lg font-medium mb-2">Belum ada skills yang ditambahkan</p>
                                    <p className="text-sm">Mulai tambahkan skill pertama kamu menggunakan form di atas!</p>
                                </div>
                            )}
                        </CardContent>
                    </Card>
